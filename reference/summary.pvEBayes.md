...
#> ✔ Generating 10000 posterior draws... [332ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3089 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (10000 signal strength posterior draws per AE-drug pair):0.3391 seconds.
#> 
