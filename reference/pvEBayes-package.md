...
approach, the K-gamma model, and the general-gamma model. The GPS,
K-gamma, and General-Gamma models are based on gamma mixture priors,
whereas the KM and Efron methods use nonparametric grid-based discrete
priors.
