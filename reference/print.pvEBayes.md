...
#> ✔ Fitting general-gamma model... [308ms]
#> 
...
#> 
#> Running time of the general-gamma model fitting: 0.3159 seconds.
#> Optimizer convergence: successful.
#> Running time for posterior draws 
#> (10000 signal strength posterior draws per AE-drug pair):0.4086 seconds.
#> 
